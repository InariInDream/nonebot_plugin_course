...
* [nonebot-plugin-course](#nonebot-plugin-course)
   ...
   * [<g-emoji class="g-emoji" alias="star2" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f31f.png">🌟</g-emoji>功能](#功能)
      * [<g-emoji class="g-emoji" alias="dart" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f3af.png">🎯</g-emoji>To_do](#to_do)
      * [暂时不会考虑添加的功能](#暂时不会考虑添加的功能)
...
<!-- Added by: runner, at: Tue Aug 23 07:41:50 UTC 2022 -->
...
1. **不同学校的上课时间有所不同**，默认设定的时间仅代表作者的学校。因此，请**务必**确认utils.py里的
    ```py
    # 上下课时间
    self.exact_time = {
...
2. 如果某一节课在不同周有不同的教室，建议在填写`classroom`的时候就以原始形式填写
   ...
   ```
   因为在除了“完整课表”以外的查询命令，都会返回查询者的当前周数。若在填写时以字典形式存每周对应的教室反而会增加填写难度和出错率。
